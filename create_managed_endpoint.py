...
def main():
   ...
   #python3 create_managed_endpoint.py 
   #--cluster-cname-pair='{"gdb-cluster1":"writer1.myhostedzone.com" ,"gdb-cluster2":"writer2.myhostedzone.com"}' 
   #--hosted-zone-name=myhostedzone.com 
   #--region-list 
   #'us-east-1,us-west-1'
    ...
    try:
        ...
        for region in regions:
            ...
            for val in vals:
                ...
                global gdbclient  
                gdbclient =boto3.client("neptune",region_name = region)
